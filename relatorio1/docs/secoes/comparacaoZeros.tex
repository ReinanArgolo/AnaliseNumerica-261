...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Visualização da penalidade imposta pela estagnação unilateral na Posição Falsa (arrasto até $k=56$) em nítido contraste com o colapso imediato da curva de Newton-Raphson.}
