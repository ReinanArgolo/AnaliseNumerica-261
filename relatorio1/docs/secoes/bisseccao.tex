...
O primeiro problema \cite{franco_calculo_2007} propõe a determinação do tempo de subida de um amplificador eletrônico, compreendido como o intervalo temporal necessário para que a resposta $g(T)$ avance de $10\%$ a $90\%$ de seu valor assintótico, sendo a função normalizada expressa por:
\begin{equation}
