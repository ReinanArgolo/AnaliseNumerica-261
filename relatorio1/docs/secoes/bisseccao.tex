...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Comportamento da convergência em escala logarítmica para a busca de $\alpha$ (Problema 3.6). A inclinação reta atesta a taxa de convergência linear do método.}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Gráfico de convergência atestando a contração linear do hipervolume de erro para a determinação da taxa de juros no Plano A.}
