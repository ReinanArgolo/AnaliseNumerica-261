...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Comparativo das taxas de convergência para $T_{0.1}$ usando $g_3(T)$ e $g_7(T)$.}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Decaimento do erro evidenciando a convergência linear para $\alpha$.}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Convergência estável para a determinação de $J_A$ e $J_B$.}
