...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Curva de erro demonstrando a taxa de convergência associada à Razão Áurea ($\approx 1.618$). Nota-se o decaimento brutal nas iterações 4 e 5, evidenciando o domínio da bacia de atração.}
